...
INPUT_DATA_PATH = '../Jan30/pe_enhi_qe_2FEB.xlsx' # abs path to input data
#INPUT_COLUMN = 'prompt1_output' # column name in input data to run inference on
OUTPUT_PATH = './pe_enhi_qe_oup1.xlsx' # abs path to output data with appropriate file extension
OUTPUT_PATH_CONTINOUS = './pe_enhi_qe_oup1_cont.csv' # abs path to output data with appropriate file extension to save intermediate output
...
def first_prompt(df):
    ...
    prompt1="""There is an English to Hindi translator which translated a source sentence from English to Hindi. For the Hindi translation, the corresponding Reference sentence has also been given. Below are the source, machine translation & reference sentence:"""
